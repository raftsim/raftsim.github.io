...
function init() {
    ...
    loader.load('objects/clip-string.stl', function (geometry) {

        clipString = new THREE.Mesh(geometry, material);

        scene.add(clipString);
    ...
    loader.load('objects/wand.stl', function (geometry) {

        wand = new THREE.Mesh(geometry, material);

        scene.add(wand);
        wand.position.z = 0.875
